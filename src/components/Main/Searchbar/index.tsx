...
function Searchbar() {
  ...
  return (
    <div className="bg-violet-900/30 relative focus-within:border-violet-600 mt-5 transition border border-violet-500/20 rounded-full w-[300px] flex items-center">
